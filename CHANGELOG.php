...
the KunenaSearch plugin, including beta and release candidate versions.
Legend:
...
+ [#20084] Added ru-RU translation (thanks ZARKOS)
...
# [#20138] Rename tables in search query from _fb_* into _kunena_*
