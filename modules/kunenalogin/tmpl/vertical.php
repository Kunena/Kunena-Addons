    ...
    <?php if ($this->type == 'logout') :
        ...
        <form action="<?php echo Route::_('index.php', true); ?>" method="post" name="login">
            ...
            <div class="klogin-links">
                <input type="submit" name="Submit" class="btn btn-default btn-primary" value="<?php echo Text::_('MOD_KUNENALOGIN_BUTTON_LOGOUT'); ?>" />
            </div>
        </form>
            ...
            <div class="userdata">
                <div id="form-login-username" class="control-group">
                    <div class="controls">
                        <div class="input-prepend">
                            <span class="add-on">
                                <span class="icon-user hasTooltip" title="<?php echo Text::_('MOD_KUNENALOGIN_USERNAME') ?>"></span>
                                <label for="modlgn-username" class="element-invisible"><?php echo Text::_('MOD_KUNENALOGIN_USERNAME'); ?></label>
                            </span>
                            <input id="modlgn-username" type="text" name="username" class="input-small" tabindex="0" size="18" placeholder="<?php echo Text::_('MOD_KUNENALOGIN_USERNAME') ?>" />
                        </div>
                    </div>
                </div>
                <div id="form-login-password" class="control-group">
                    <div class="controls">
                        <div class="input-prepend">
                            <span class="add-on">
                                <span class="icon-lock hasTooltip" title="<?php echo Text::_('MOD_KUNENALOGIN_PASSWORD') ?>"></span>
                                <label for="modlgn-passwd" class="element-invisible"><?php echo Text::_('MOD_KUNENALOGIN_PASSWORD'); ?></label>
                            </span>
                ...
                <div id="form-login-submit" class="control-group center">
                    <p>
                        <button type="submit" tabindex="3" name="submit" class="btn btn-primary btn">
                            <?php echo Text::_('MOD_KUNENALOGIN_BUTTON_LOGIN'); ?>
                        </button>
                    </p>
