                ...
                <ul>
                    <?php if ($this->params->get('greeting')) :
                        ...
                        <li class="klogin-hiname">
                            <?php echo Text::sprintf('MOD_KUNENALOGIN_HINAME', '<strong>' . $this->me->getLink($this->me->getName()) . '</strong>', $this->me->getName()); ?>
                        </li>
                    <?php endif; ?>
                    <?php
        ...
        <form action="<?php echo Route::_('index.php', true); ?>" method="post" name="login" class="klogin-form-login">
            ...
            <ul class="klogin-logoutfield">
                ...
                <span class="klogin-form-login-username">
                    ...
                    <input id="klogin-username" class="klogin-username" type="text" name="username" class="inputbox" alt="username" size="18" value="<?php echo Text::_('MOD_KUNENALOGIN_USERNAME'); ?>" onblur="if(this.value=='') this.value='<?php echo Text::_('MOD_KUNENALOGIN_USERNAME'); ?>';" onfocus="if(this.value=='<?php echo Text::_('MOD_KUNENALOGIN_USERNAME'); ?>') this.value='';" />
                </span>
                    <?php if ($this->remember) :
                        ?>
                        <span class="klogin-form-login-remember"><label for="klogin-remember">
                                <input id="klogin-remember" class="klogin-remember" type="checkbox" name="remember" value="yes" alt="<?php echo Text::_('MOD_KUNENALOGIN_REMEMBER_ME') ?>" />
                                <?php echo Text::_('MOD_KUNENALOGIN_REMEMBER_ME') ?></label>
                </span>
                    <?php endif; ?>
                </li>
                ...
                <span class="klogin-form-login-password">
                    ...
                    <input id="klogin-passwd" class="klogin-passwd" type="password" name="password" class="kinputbox" size="18" alt="password" value="<?php echo Text::_('MOD_KUNENALOGIN_PASSWORD'); ?>" onblur="if(this.value=='') this.value='<?php echo Text::_('MOD_KUNENALOGIN_PASSWORD'); ?>';" onfocus="if(this.value=='<?php echo Text::_('MOD_KUNENALOGIN_PASSWORD'); ?>') this.value='';" />
                </span>
