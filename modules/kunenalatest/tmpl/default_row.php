...
<li class="klatest-subject">
	<?php
	echo modKunenaLatest::shortenLink( $this->getTopicLink($this->topic, 'unread', null , modKunenaLatest::setSubjectTitle($this, $this->topic->last_post_message)), $this->params->get ( 'titlelength' ) );
