    ...
    <ul class="klatest-itemdetails">
        ...
        <?php elseif ($this->params->get('sh_topiciconoravatar') == 0) : ?>
            <li class="klatest-topicicon">
                <?php if ($topic->unread && $this->params->get('sh_unread') == 1) : ?>
        ...
        <?php if ($this->params->get('sh_author')) : ?>
            <li class="klatest-author"><?php echo Text::_('COM_KUNENA_BY') . ' ' . $this->topic->getLastPostAuthor()->getLink(null, Text::sprintf(
                'COM_KUNENA_VIEW_USER_LINK_TITLE',
                $this->topic->getLastPostAuthor()->getName()
            ), '', '', KunenaTemplate::getInstance()->tooltips(), $this->category->id);?></li>
        <?php endif; ?>
