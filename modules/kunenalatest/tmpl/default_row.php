...
<li class="klatest-subject">
	<?php echo modKunenaLatest::shortenLink( $this->getTopicLink($this->topic, 'unread', null , modKunenaLatest::setSubjectTitle($this->params,$this->topic)), $this->params->get ( 'titlelength' ) );
