...
<li class="klatest-subject">
	...
	{
		echo ModuleKunenaLatest::shortenLink($this->getTopicLink($this->topic, 'unread', null, null, ModuleKunenaLatest::setSubjectTitle($this, $this->message->message)), $this->params->get('titlelength'));
	}
	else
	{
		echo ModuleKunenaLatest::shortenLink($this->getTopicLink($this->topic, $this->message, null, null, ModuleKunenaLatest::setSubjectTitle($this, $this->message->message)), $this->params->get('titlelength'));
	}
