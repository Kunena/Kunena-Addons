...
<li class="klatest-item">
	<ul class="klatest-itemdetails">
		...
		<?php if ($this->params->get('sh_firstcontentcharacter')) : ?>
			<li class="klatest-preview-content"><?php echo KunenaParser::stripBBCode($this->message->message, $this->params->get('lengthcontentcharacters')); ?></li>
		<?php endif; ?>
		...
		<?php if ($this->params->get('sh_author')) : ?>
			<li class="klatest-author"><?php echo Text::_('MOD_KUNENALATEST_POSTED_BY') . ' ' . $this->message->getAuthor()->getLink(); ?></li>
		<?php endif; ?>
		<?php if ($this->params->get('sh_time')) : ?>
			<li class="klatest-posttime"><?php $override = $this->params->get('dateformat');
				echo KunenaDate::getInstance($this->message->time)->toKunena($override ? $override : 'config_postDateFormatt'); ?></li>
		<?php endif; ?>
	</ul>
</li>
