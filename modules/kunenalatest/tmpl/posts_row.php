...
<li class="klatest-subject">
	<?php
	echo modKunenaLatest::shortenLink( $this->getTopicLink($this->topic, $this->message, null , modKunenaLatest::setSubjectTitle($this->params,$this->topic)), $this->params->get ( 'titlelength' ) );
	...
	if ($this->params->get ( 'sh_postcount' )) {
		echo JText::sprintf( 'MOD_KUNENALATEST_POST_COUNT', $this->topic->posts);
	}
	?>
</li>
